<template>
  <div>
    <div
      class="hero bg-grey-dark"
      :style="
        `background:url(${game.screenshots[0].url.replace(
          't_thumb',
          't_1080p'
    ...
    >
      <div
        class="container mx-auto flex flex-col md:flex-row items-end pb-8"
        style="height:350px"
      >
    ...
    <div class="container mx-auto flex flex-col md:flex-row">
      <div class="w-full md:w-1/4 -mt-16">
        ...
        <div v-if="game.total_rating" class="mb-10">
...
export default {
  asyncData({ params, error }) {
    ...
    return axios
      .get(
        `${proxyurl}https://api-v3.igdb.com/games/${
          params.id
        }/?fields=name,cover.url,summary,platforms.name,first_release_date,websites,total_rating,screenshots.url,total_rating&expand=platforms,screenshots,cover`
      )
      .then(res => {
        return {
          game: res.data[0]
